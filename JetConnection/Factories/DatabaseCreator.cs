...
namespace JetConnection.Factories
{
       ...
       : JetDatabaseCreator
    {
        ...
        {
            var connectionString = JetConnection.GetConnectionString(filePath, Constants.DataAccessProviderType.OleDb);
